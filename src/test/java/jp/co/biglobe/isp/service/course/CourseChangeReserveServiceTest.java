...
public class CourseChangeReserveServiceTest {

    @Autowired
    public DbUnitTester tester;

    @Autowired
    private CourseChangeReserveService courseChangeReserveService;



    @Test
    public void コース変更予約OK() throws Exception {
        ...
        courseChangeReserveService.受け付ける(validAuth, new ChangeReserveCourse(CourseName.ニコニコ));

        CourseAssert courseAssert = new CourseAssert(tester);
        courseAssert.assertTableWithAllColumns(FixtureCourse.Two.コース変更予約中());
